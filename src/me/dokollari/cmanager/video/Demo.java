...
public class Demo
{
	public static void main(String[] args) throws Exception {
		...
		// FAQ about IplImage:
		// - For custom raw processing of data, getByteBuffer() returns an NIO
		// direct
		...
		// screenNumber.
		// We should also specify the relative monitor/camera response for proper
		// gamma correction.
		...
		randomAxis.put((Math.random() - 0.5) / 4, (Math.random() - 0.5) / 4,
				(Math.random() - 0.5) / 4);
		...
		while (frame.isVisible() && (grabbedImage = grabber.grab()) != null) {
			...
			// To check if an output argument is null we may call either isNull()
			// or equals(null).
